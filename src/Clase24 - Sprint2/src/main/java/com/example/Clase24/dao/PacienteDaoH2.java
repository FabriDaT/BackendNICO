...
public class PacienteDaoH2 implements Idao<Paciente>{
    ...
    public void eliminar(Long id) {
        Connection connection = BBDD.connection();
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(BBDD.delete("PACIENTES", "ID"));
    ...
    public Paciente listar(Long id) {
        ...
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(BBDD.select("PACIENTES", "ID"));
            preparedStatement.setLong(1,id);
