...
public class BaseDato {
    ...
    public String update(String tabla, String columna){
        return switch (tabla){
            case "PACIENTES" -> "UPDATE PACIENTES SET " + columna + " = ? WHERE ID = ?;";
            case "DIRECCIONES" -> "UPDATE DIRECCIONES SET " + columna + " = ? WHERE ID = ?;";
            case "ODONTOLOGOS" -> "UPDATE ODONTOLOGOS SET " + columna + " = ? WHERE ID = ?;";
            default -> "nombre de tabla incorrecta";
        };
    }
}
